...
public class AirDroid extends StandardDroid{
    public AirDroid() {
        super();
        this.hitChance = (int) (Math.random() * 10 + 1 + 10);
        this.health = (int) (Math.random() * 3 + 1 + 2);
        this.damage = (int) (Math.random() * 5 + 1 + 3);
        this.critChance = (int) (Math.random() * 10 + 1 + 10);
    }
